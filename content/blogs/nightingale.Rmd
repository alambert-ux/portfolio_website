...
# Critiquing European Governments' COVID-19 Response Strategies
...
```{r stringency_cases,fig.height = 3,fig.width = 6,message=FALSE,results='hide',warning=FALSE}
...
```{r stringency_deaths,fig.height = 3,fig.width = 6,message=FALSE,results='hide',warning=FALSE}
...
```{r wave1_countries,fig.height= 4,fig.width=7,message=FALSE,results='hide',warning=FALSE}
...
```{r wave2_countries,fig.height= 4,fig.width=7,message=FALSE,results='hide',warning=FALSE}
...
```{r LR Model Variable Importance,fig.height = 2,fig.width = 4,message=FALSE,results='hide',warning=FALSE}
