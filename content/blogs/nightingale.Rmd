...
```{r dataset1 skim, message=FALSE,results='hide',warning=FALSE, eval=FALSE}
skim(covid_data)
```

```{r dataset1 remove duplicates and empties,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r dataset1 clean iso_code and continent,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
# NAs in iso_code
...
```{r dataset1 clean gdp_per_capita,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r dataset2 skim,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
skim(hospital_data)
```
...
```{r dataset2 clean indicator and value,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r clean data format,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r explore testing,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
skim(covid_testing)
...
```{r clean testing,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r merge dataset,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r select europe,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r enriching the dataset,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r top 5 sum new_cases countries,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r mapping,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r plot01, eval=TRUE, include=TRUE, fig.show=TRUE, eval=TRUE} 
...
``` {r lockdown_maps,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r combine_lockdown_maps, fig.height = 10,fig.width = 10,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r stringency_cases,fig.height = 5,fig.width = 10,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r stringency_deaths,fig.height = 5,fig.width = 10,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r daily_test_change,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r uk_1wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r poland_1wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r italy_1wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r sweden_1wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r france_1wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r denmark_1wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r wave1_countries,fig.height= 6,fig.width=12,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r uk_2wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r poland_2wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r italy_2wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r sweden_2wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r france_2wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r denmark_2wave,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r wave2_countries,fig.height= 6,fig.width=12,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r defining variables,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
...
```{r define control variable,message=FALSE,results='hide',warning=FALSE, eval=FALSE}
